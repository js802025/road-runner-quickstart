...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(1.55, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.1, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.36;
